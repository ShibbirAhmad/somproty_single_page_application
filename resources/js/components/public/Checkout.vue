                ...
                <div class="custom-box">
                  ...
                  <form @submit.prevent="chekout">
                    ...
                    <div class="form-group">
                      ...
                      <br />
                     <div v-show="sub_cities" class="form-grop">
                        <label class="control-label" for="input-email">Hometown</label>
                        <select
                          name="sub_city"
                        ...
                        >
                          <option value="select Hometown" selected disabled>Select Hometown</option>
                          <option
                            value
                            v-for="(sub_city,index) in sub_cities"
                            :key="index"
                            :value="sub_city.id"
  ...
  methods: {
    ...
    getCity() {
      ...
      getSubCity() {
        ...
        if (this.form.city!=0) {
          axios.get("/_public/api/get/sub/city/accroding/to/city/"+this.form.city)
        .then((resp) => {
            console.log(resp);
