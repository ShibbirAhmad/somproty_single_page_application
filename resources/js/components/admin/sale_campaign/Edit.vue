          ...
          <div class="col-lg-6 col-lg-offset-2">
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <form
                  @submit.prevent="updateSaleCampaign"
...
export default {
  ...
  methods: {
    getSaleCampaign() {
      axios.get("/api/campaign/sale/edit/item/"+this.$route.params.id)
      .then((resp) => {
        console.log(resp);
        if (resp.data.status == "OK") {
          this.form.name = resp.data.sale_campaign.name;
          this.form.background_color = resp.data.sale_campaign.background_color;
          this.form.border_color = resp.data.sale_campaign.border_color;
          this.form.border_width = resp.data.sale_campaign.border_width;
          this.form.order_by = resp.data.sale_campaign.order_by;
          this.form.expired_date = resp.data.sale_campaign.expired_date;
        }
      });
    },
    ...
    updateSaleCampaign() {
      this.form
        .post("/api/sale/campaign/edit/"+this.$route.params.id, {
          transformRequest: [
