                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="form-control"
                      :class="{
                        'is-invalid': form.errors.has('alert_quantity'),
                      }"
                      autocomplete="off"
                      placeholder="discount"
                    />
                    <has-error :form="form" field="alert_quantity "></has-error>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">
                    ...
                    <small>
                      <b>
                        <i>(Every image can not be bigger than 500*500 px)</i>
                      </b>
                    </small>
                  </h3>
                </div>
    ...
    addImage(file) {
      ...
      if (file.size / 1024 > 100) {
        Swal.fire({
          type: "warning",
          text:
            "File size can not be bigger then 100kb.Reference file size is" +
      ...
      reader.onload = (evt) => {
        ...
        img.onload = () => {
          if (img.width <= 500 && img.height <= 500) {
            ...
            this.disabled = true;
            alert(
              "Image maximu size 500*500px.But Upload imaze size" +
                img.width +
                "*" +
                img.height +
                "px"
