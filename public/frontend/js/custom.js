...
$(".latest_category .tab_content:first").show();
	//Default Action
    $(".latest_category ul.sub-caty li:first").addClass("active").show(); //Activate first tab
    //On Click Event
    $(".latest_category ul.sub-caty li").on("click", function() {
        $(".latest_category ul.sub-caty li").removeClass("active"); //Remove any "active" class
